...
# BSpadavecchia,3.14.2022,Added code to complete main module
# ------------------------------------------------------------------------ #
...
lst_file_data = P.read_data_from_file("EmployeeData.txt")
...
while True:
    ...
    if str_choice == "1":
        ...
        P.save_data_to_file("EmployeeData.txt", lst_emp_table)
